...
class Logger {
   ...
   *
   * @param {Object} args - An object containing optional arguments:
   *   - {boolean} silent - If true, suppresses console output.
   *   - {boolean} verbose - If true, enables verbose console output.
   *   - {boolean} watch - If true, enables watch mode.
   */
  constructor(args) {
